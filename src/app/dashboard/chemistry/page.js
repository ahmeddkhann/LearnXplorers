...
const Chemistry = () => {
    ...
    return (
        <div className="bg-orange-400 py-10 min-h-screen overflow-hidden">
            {/* Navbar */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {chemistryBranches.map((branch, index) => (
                    <div key={index} className="bg-blue-400 text-green-800 shadow-md rounded-lg p-4 mx-4 transition-transform duration-300 hover:scale-105">
